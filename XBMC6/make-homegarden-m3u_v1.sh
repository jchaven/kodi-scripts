...
if [ -f "$LOCKFILE" ]; then
  ...
  # create single list of all videos in specific folders (array not supported)
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Big Dreams Small Spaces"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Gardeners' World"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Grand Designs"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Grand Designs New Zealand"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Grow Your Own at Home"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Love Your Garden"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Gardeners' World"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Homegrown"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Love Your Home and Garden"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/This Old House"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Tiny Houses"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Monty Don's Gardens"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Various Design"  
  #GetVideos "/media/Proraid/Media/Other/Home and Garden/Grand Designs - The Streets"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Queer Eye"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/My Yard Goes Disney"
  GetVideos "/media/Proraid/Media/Other/Home and Garden/Kill Your Lawn"
